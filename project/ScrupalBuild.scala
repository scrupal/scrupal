...
object ScrupalBuild extends Build with AssetsSettings with Dependencies {
  ...
  lazy val root = Project(base_name, file("."))
    ...
    .dependsOn(admin_proj, config_deps, doc_deps, core_deps, api_deps, storage_deps, utils_deps)
    .aggregate(admin_proj, config_proj, doc_proj, core_proj, api_proj, storage_proj, utils_proj)
