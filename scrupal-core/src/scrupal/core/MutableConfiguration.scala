...
import scrupal.core.api.{Validator, ValidationResult, Type}
import scrupal.utils.Configuration

/** A Configuration that can validate and mutate
 * Created by reidspencer on 11/7/14.
 */
case class MutableConfiguration(types: Map[String,Type], defaults: Map[String,BSONValue]) extends Validator {
